...
for filename in os.listdir(raw_data_dir):
    if filename.endswith('_matches.csv'):
        ...
        infinite_rows = data[data[numeric_columns].applymap(np.isinf).any(axis=1)] # infinite values are being squashed here (done after calculating price ratio because of potentially introduced inf's)
